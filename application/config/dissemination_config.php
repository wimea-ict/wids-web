...
/*
|--------------------------------------------------------------------------
| Dissemination Metadata (DO NOT CHANGE!!!)
|--------------------------------------------------------------------------
|
*/
$config['dissemination_version'] = '0.0.1';
$config['dissemination_release_date'] = '01 June 2016';
$config['dissemination_upgradeable'] = FALSE;
$config['dissemination_previous_version'] = '0.0.0';
...
/* End of file dissemination_config.php */
/* Location: ./application/config/dissemination_config.php */
