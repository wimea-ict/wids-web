        ...
        <!-- Main content -->
         ...
         <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#"><i class="fa fa-dashboard"></i>Advisories</a></li>
              ...
              <div class='box'>
                <div class='box-header'>
                  <h3 class='box-title'>LIST OF POSSIBLE ADVISORIES <?php
                   if($_SESSION['usertype'] == "" || $_SESSION['usertype'] == "forecast"){
        ...
        <?php echo anchor(site_url('index.php/Possible_advisories/displayform'), '<i class="fa fa-plus"></i> Add New', 'class="btn btn-primary btn-sm"'); ?>
