...
<?php endif; ?>
		...
		<link rel="stylesheet" href="<?php echo base_url($plugins_dir . '/timepicker/bootstrap-timepicker.min.css');?>">
		  <!-- Select2 -->
		<link rel="stylesheet" href="<?php echo base_url($plugins_dir . '/select2/select2.min.css');?>">

        <!-- jquery-->
        <script src="<?php echo base_url($plugins_dir . '/jQuery/jQuery-2.2.0.min.js'); ?>"></script>
