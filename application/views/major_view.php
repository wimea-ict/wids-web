            ...
            <div class='col-xs-12'>
              <div class='box'>
                <div class='box-header'>
                  <h3 class='box-title'>LIST OF MAJOR SECTOR <?php
...
<!---------------------------------- AMoko --------------------->
        ...
        <tr>
			...
			<?php 
			echo '  ';
           echo anchor(site_url('index.php/Major_Sector/update/'.$re->id),'<i class="fa fa-pencil-square-o"></i>',array('title'=>'Edit','class'=>'btn btn-primary btn-sm')); 
			echo '  '; 
			echo anchor(site_url('index.php/Major_Sector/delete/'.$re->id),'<i class="fa fa-trash-o"></i>','title="Delete" class="btn btn-danger btn-sm" onclick="javascript: return confirm(\'Are You Sure ?\')"'); 
