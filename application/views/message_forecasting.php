                        ...
                        <form class="form-horizontal" action="<?php echo $action; ?>" method="post">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 text-aqua">                     
                                        <textarea class="form-control" rows="3" id="sendto_list" name="Enter phone numbers separated by semi colon" placeholder="Enter your message here..." ></textarea>
                                        <h6 class="pull-right" id="count_message"></h6>
                                        <span class="help-block"><?php echo form_error('sendto') ?></span>
                                    </div>
