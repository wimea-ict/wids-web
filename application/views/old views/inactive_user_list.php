        ...
        <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#"><i class="fa fa-dashboard"></i> Deactivated User List</a></li>
            ...
            <div class='col-xs-12'>
              <div class='box'>
                <div class='box-header'>
                  <h3 class='box-title'>DEACTIVATED USERS <?php
	    ...
	    <tbody>
            <?php
            $start = 0;
            foreach ($this->Landing_model->get_inactive_users() as $users)
            {
			...
			echo ' '; 
			 if($_SESSION['usertype'] == "wimea" || $_SESSION['usertype'] == "forecast"){
                echo anchor(site_url('index.php/Landing/activate_user/'.$users->id),'<i class="fa fa-eye"></i>',array('title'=>'Activate','class'=>'btn btn-danger btn-sm')); 			
			 }
			 ?>
		    </td>
	        </tr>
