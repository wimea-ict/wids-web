...
$(document).ready(function(){
  ...
  <div class="col-md-12" style=" height:100%;background-color: #ecf0f5;" >
         ...
         <section class="content-header" style="margin-top: -8%;" >
    ...
    <!===================================================================================>
     ...
     <div id="daily_forecast" style="margin-top: 10%;">
 ...
 <!------------------------------DEKADAL REQUEST DATA--------------  -------------------------------------->
       <?php }else if($category1 == "Dekadal Forecast"){
          ...
          foreach($dekadal_forecast_data as $dekadal){
           ...
           ?>
           <div id="seasonal_forecast" style="margin-top: 10%;">
           <a  href ="<?php site_url('index.php/auth/index') ?>" style="margin-left:100%;" class="glyphicon glyphicon-remove-sign"> </a>
    ...
    <!------------------------------- Amoko ------------------------------------>  
         <div id="seasonal_forecast" style="margin-top: 10%;">
              <h4>Seasonal Forecast for <?php echo $divisio_name ?>
                <div style="background-color: cornflowerblue;height: 3px;margin-top: 100%; width: 50%;"></div>
              </h4>
          ...
          <?php 
           ...
           ?>
            ...
            <?php $count++; endforeach; foreach ($seasonal_advice as $advice) : 
              if(date('Y') == $advice['year'] &&( ($advice['abbreviation']) == $season)){
              echo "<br><h3>Advisories</h3>";
          ?>
