 ...
 public function __construct() {
   ...
   if(!empty($this->config->item('country'))){
	...
	///	  echo $this->session->userdata('database_name')." is the database";
         ...
         //-----------------SEASONAL DATA--------------------
         $identifier = 'Water';
         $data['get_advice'] = $this->Advisory_model->get_advice(1, $identifier);
...
///////////////////////////// Amoko//////////////////////////////		
               ...
               //print_r($daily_forecast_region_data);	exit();
...
//--------------------------------------------------------------------------------
  ...
  array_push($q,"INSERT INTO `region` (`id`, `region_name`) VALUES
	...
	array_push($q,"CREATE TABLE weather_category (
		  ...
		  img varchar(23) NOT NULL,
		  widget varchar(100) NOT NULL
		) ENGINE=InnoDB DEFAULT CHARSET=latin1;");

	array_push($q,"INSERT INTO `weather_category` (`cat_name`, `img`, `widget`) VALUES
		( 'heavy rain', 'img/rain.PNG', 'heavyrain'),
		('light thunder showers', 'img/thunderstorm.PNG', 'thundershowers'),
		('sunny intervals', 'img/sunny.PNG', 'partlysunny'),
		( 'showers', 'img/showers.ico', 'rainy'),
		( 'sunny', 'img/image1s0.jpg', 'sunny'),
		('cloudy', 'img/img-thing.jpg', 'cloudy'),
		( 'flood', 'img/floudimages.jpg', 'flood'),
		( 'light rain', 'img/H.PNG', 'lightrain'),
		( 'heavy thunder', 'img/lightthunder.ico', 'thunder'),
		('isolated showers', 'isolated_showers.jpg', 'lightrain'),
		( 'isolated rain', 'img/showers.ico', 'lightrain'),
		( 'light isolated showers', 'img/showers.ico', 'lightrain'),
		('partly cloudy', 'img/partlyCloudy.png', 'partlysunny');");
...
(2, 'Dekadal forecast', '/index.php/Decadal_forecast/index', 'fa fa-cloud', 1, 1, 'one'),
...
array_push($q,"
	...
	array_push($q,"INSERT INTO `possible_advisories` (`pos`, `cat`, `advise`, `state`) VALUES
		...
		(3, '1', 'Enhance rain water harvesting (in-situ, roof, surface-run-off) for usage when the rains start is encouraged.', 'normald'),
		(4, '1', 'Encourage good soil and water conservation practices e.g. terraces, stone bunds, trenches, grass bunds, mulching to control soil erosion and boost soil moisture retention; and Drip irrigation where possible is encouraged.', 'normal'),
		(5, '1', 'Encourage pasture preservation/making hay.', 'normal'),
		(6, '1', 'Carryout good agronomic practices for crops such as proper spacing, proper use of fertilizer.', 'normal'),
		(7, '1', 'Diversify for example intercropping and mixed cropping; Maize/beans, maize-cowpea, maize-soybean.', 'normal'),
		(8, '1', 'Carryout low-cost irrigation systems like small-scale drip irrigation e.g. use of plastic bottles filled with water.', 'normal'),
		(9, '1', 'Encourage the usage of improved post-harvest technologies e.g. super bags, metallic silos, cocoons.', 'normal'),
		(10, '1', 'Pasture preservation (making hay and silage) and use available water sparingly.', 'normal'),
		(11, '1', 'Encourage farmers to store enough food for household use especially cereals.', 'normal'),
		(12, '1', 'Farmers should mulch their gardens to conserve moisture available in the soil.', 'normal'),
		(13, '1', 'Planting of leafy vegetables and drip irrigation should be encouraged.', 'normal'),
		(14, '1', 'Supplementary irrigation to sustain crop growth.', 'normal'),
		(16, '1', 'Observe soil and water conservation practices such as mulching to reduce soil moisture.', 'normal'),
		(17, '1', 'Observe good soil and water conservation practices.', 'above'),
		(18, '1', 'Dig water trenches and drainage channels to minimize flash floods and water logging.', 'above'),
		(19, '1', 'Encourage proper agronomic practices such as timely weeding and harvesting.', 'above'),
		(20, '1', 'Encourage proper food storage.', 'above'),
		(21, '1', 'Encourage improved high yielding varieties ie cereals, soya, sorghum.', 'above'),
		(22, '1', 'Avoid planting in areas prone to water logging.', 'above'),
		(23, '1', 'Backyard/homestead gardening of vegetables such as nakati, dodo, egg-plants, etc.', 'above'),
		(24, '1', 'Establishment of water harvesting structures at household and communal level.', 'above'),
		(25, '1', 'Soil and water conservation practices e.g. trenches, grass bunds, mulching to enhance soil moisture retention and control erosion.', 'above'),
		(26, '1', 'Enhance good agronomic practices (proper spacing, fertilizer use, weeding).', 'above'),
		(27, '1', 'Livestock farmers are advised to plant livestock fodders at the onset of the rains.', 'above'),
		(28, '1', 'Enhance surveillance of crop gardens for pests and diseases and timely control (crop rotation MSV, Root Rot, disease resistant varieties like NABE15-23, Longe10H-11H, 7H).', 'above'),
		(29, '1', 'Encourage tree planting including agro-forestry and fruit trees).', 'above'),
		(30, '1', 'Guard against tick-borne diseases and worms.', 'above');");
