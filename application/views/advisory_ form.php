...
<section class="content-header">
        ...
        <tr><td>Advisory Summary:</td>
            <td><textarea class="form-control" rows="3" name="summary" id="summary" required  placeholder="Advisory Summary"><?php echo $summary; ?></textarea>
        </td>        
        </tr>       
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        for(i=0; i<data.length; i++){
                          html +='<input type="checkbox" required value="';
                          html += data[i].advise;
                          html +='" name="ad">';
                          html += data[i].advise;
                            html +='<br>';
